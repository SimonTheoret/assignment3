...
discriminator_optimizer = torch.optim.Adam(discriminator.parameters(),lr = disc_lr, betas=(0.5, 0.999))    # WRITE CODE HERE
generator_optimizer = torch.optim.Adam(generator.parameters(),lr = gen_lr, betas=(0.5, 0.999))        # WRITE CODE HERE
